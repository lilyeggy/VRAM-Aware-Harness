...
| 还剩几个没修？ | **本项目代码范围内 0 个**。2026-09-11 分三轮清完：N22/N25/N23/N18/N19（高危，含真机复验）+ N20/N21/N24/N26（中等）+ 最后 7 项 N27/N5/N15/N16/N9/N10/N14（§25）。**未修项只剩"测量有效性"（测试驱动 T1–T5）与明确不做的多机/生产级能力** | [缺陷台账 §23–§25](known-issues.zh-CN.md)、[缺陷登记](defect-register.zh-CN.md) |
...
5. **~~已入库测试相对已入库源码偏旧~~（2026-09-12 已消除）。** 本轮 9 个改动 + 34 条新增的测试路径最初按约定只留本地；**2026-09-12 已全部入库**，新克隆里 `bun test` 即应 **476 pass / 0 fail**（98 个文件），`bun run typecheck` 全绿。
